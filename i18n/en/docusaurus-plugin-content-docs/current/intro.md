...
**Payload** is the processing of Gadget chains, for example, `JavaNativePayload` serializes the Gadget chain to generate Java deserialization Payload; `HessianPayload`.
